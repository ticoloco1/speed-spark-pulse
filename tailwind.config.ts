  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "boost-pulse": {
          "0%, 100%": { boxShadow: "0 0 0 0 hsl(var(--racing-red) / 0.7)" },
          "50%": { boxShadow: "0 0 0 14px hsl(var(--racing-red) / 0)" },
        },
        "count-up": {
      ...
      animation: {
        ...
        "ticker-left-slow": "ticker-left 80s linear infinite",
        "ticker-left": "ticker-left 45s linear infinite",
